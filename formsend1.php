...
<tr>
<td style="border-bottom: 1px solid #A2A2A2;width: 193px;border-right: 1px solid #A2A2A2;">
<h4 style="margin: 4px;">	Желаемая дата:</h4></td>
<td style="border-bottom: 1px solid #A2A2A2;padding: 4px;">	'. $dt_form .'</td>
</tr>


<tr><td style="width: 193px;border-right: 1px solid #A2A2A2;">
<h4 style="margin: 4px;">	Комментарии и пожелания:</h4></td>
...
$mail = new PHPMailer();
$mail->From = "i4web.ru/199";
$mail->Subject = "Запись на сервис";
$mail->FromName = "Заявка с сайта";
$mail->AddAddress('antur.plus@mail.ru');
$mail->IsHTML(true);
...
font-size: 30pt;
font-weight: 400;
line-height: 1.2em;">Спасибо за отправку запроса. Мы свяжемся с вами.<br><a href="/">Нажмите, чтобы вернуться на главную страницу</b><img src="http://i4web.ru/199/done.jpg" alt="Сделано!" title="Сделано!" style="margin: 0px auto;display: block;margin-top: 37px"/></a>'
<?php 
}
